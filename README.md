...
<ul>
  ...
  <li><strong>indexer-post-processor =></strong> Basic files to boost liferay searcher.</li>
  <li><strong>jsp-bag-web-content   =></strong> Module to override a file from a Liferay module. This one prints Structure Key and Template key inside Edit Mode for Liferay 7.4 DXP.</li>
  <li><strong>message-bus-listener  =></strong> Module to create MessageListener event. Shows the file title when a PDF document is processed.</li>
