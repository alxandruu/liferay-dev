		...
		>
			...
			<div class="article-content-content">
			    <div>
                    <ul class="tbar-nav">
                        <li class="tbar-item tbar-item-expand">
                            <aui:input type="text" name="structure_Key" readonly="true" cssClass="form-control-inline text-center" value='<%= HtmlUtil.escape(ddmStructure.getStructureKey()) %>' label="Structure Key"/>
                        </li>
                        <li class="tbar-item tbar-item-expand">
                            <aui:input type="text" name="template_Key" readonly="true" cssClass="form-control-inline text-center" value='<%= HtmlUtil.escape(journalEditArticleDisplayContext.getDDMTemplateKey()) %>' label="Template Key"/>
                        </li>
                    </ul>
                </div>
