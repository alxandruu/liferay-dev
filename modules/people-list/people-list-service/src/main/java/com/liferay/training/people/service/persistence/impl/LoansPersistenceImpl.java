...
package com.liferay.training.people.service.persistence.impl;
...
import com.liferay.training.people.model.LoansTable;
import com.liferay.training.people.model.impl.LoansImpl;
import com.liferay.training.people.model.impl.LoansModelImpl;
...
import com.liferay.training.people.service.persistence.impl.constants.PeoplePersistenceConstants;
...
/**
 * The persistence implementation for the loans service.
 *
 * <p>
 ...
 * @generated
 */
@Component(service = {LoansPersistence.class, BasePersistence.class})
public class LoansPersistenceImpl
	extends BasePersistenceImpl<Loans> implements LoansPersistence {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use <code>LoansUtil</code> to access the loans persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static final String FINDER_CLASS_NAME_ENTITY =
		LoansImpl.class.getName();
	 ...
	 */
	@Override
	public List<Loans> findByUuid(String uuid) {
	 ...
	 */
	@Override
	public List<Loans> findByUuid(String uuid, int start, int end) {
	...
	public List<Loans> findByUuid(
		...
		if (useFinderCache) {
			list = (List<Loans>)finderCache.getResult(finderPath, finderArgs);

			if ((list != null) && !list.isEmpty()) {
				for (Loans loans : list) {
					if (!uuid.equals(loans.getUuid())) {
						list = null;
		...
		if (list == null) {
			...
			sb.append(_SQL_SELECT_LOANS_WHERE);
			...
			if (orderByComparator != null) {
				...
				sb.append(LoansModelImpl.ORDER_BY_JPQL);
			}
			...
			try {
				...
				list = (List<Loans>)QueryUtil.list(
	...
	public Loans findByUuid_First(
		...
		Loans loans = fetchByUuid_First(uuid, orderByComparator);
		...
		throw new NoSuchLoansException(sb.toString());
	}
	...
	public Loans fetchByUuid_First(
		...
		List<Loans> list = findByUuid(uuid, 0, 1, orderByComparator);
	...
	public Loans findByUuid_Last(
		...
		Loans loans = fetchByUuid_Last(uuid, orderByComparator);
	...
	public Loans[] findByUuid_PrevAndNext(
		...
		Loans loans = findByPrimaryKey(peopleId);
		...
		try {
			...
			Loans[] array = new LoansImpl[3];

			array[0] = getByUuid_PrevAndNext(
				session, loans, uuid, orderByComparator, true);

			array[1] = loans;

			array[2] = getByUuid_PrevAndNext(
				session, loans, uuid, orderByComparator, false);
	...
	protected Loans getByUuid_PrevAndNext(
		Session session, Loans loans, String uuid,
		OrderByComparator<Loans> orderByComparator, boolean previous) {
		...
		if (orderByComparator != null) {
			for (Object orderByConditionValue :
					orderByComparator.getOrderByConditionValues(loans)) {
	...
	public int countByUuid(String uuid) {
		...
		if (count == null) {
			...
			sb.append(_SQL_COUNT_LOANS_WHERE);
	...
	private static final String _FINDER_COLUMN_UUID_UUID_2 = "loans.uuid = ?";

	private static final String _FINDER_COLUMN_UUID_UUID_3 =
		"(loans.uuid IS NULL OR loans.uuid = '')";
	...
	public Loans findByUUID_G(String uuid, long groupId)
		...
		Loans loans = fetchByUUID_G(uuid, groupId);
	...
	public Loans fetchByUUID_G(
		...
		if (result instanceof Loans) {
			Loans loans = (Loans)result;

			if (!Objects.equals(uuid, loans.getUuid()) ||
				(groupId != loans.getGroupId())) {
	...
	public Loans removeByUUID_G(String uuid, long groupId)
		...
		Loans loans = findByUUID_G(uuid, groupId);
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_3 =
		"(loans.uuid IS NULL OR loans.uuid = '') AND ";
	 ...
	 */
	@Override
	public List<Loans> findByUuid_C(String uuid, long companyId) {
		return findByUuid_C(
	 ...
	 */
	@Override
	public List<Loans> findByUuid_C(
	...
	public Loans findByUuid_C_First(
		...
		Loans loans = fetchByUuid_C_First(uuid, companyId, orderByComparator);
	...
	public Loans findByUuid_C_Last(
		...
		Loans loans = fetchByUuid_C_Last(uuid, companyId, orderByComparator);
	...
	public Loans[] findByUuid_C_PrevAndNext(
		...
		try {
			...
			array[0] = getByUuid_C_PrevAndNext(
				session, loans, uuid, companyId, orderByComparator, true);

			array[1] = loans;

			array[2] = getByUuid_C_PrevAndNext(
				session, loans, uuid, companyId, orderByComparator, false);
	...
	protected Loans getByUuid_C_PrevAndNext(
		Session session, Loans loans, String uuid, long companyId,
		OrderByComparator<Loans> orderByComparator, boolean previous) {
	 ...
	 */
	@Override
	public List<Loans> findBysurname(String surname, int start, int end) {
	 ...
	 */
	@Override
	public List<Loans> findBysurname(
	...
	public List<Loans> findBysurname(
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (Loans loans : list) {
					if (!surname.equals(loans.getSurname())) {
						list = null;
	...
	public Loans findBysurname_First(
		...
		Loans loans = fetchBysurname_First(surname, orderByComparator);
	...
	public Loans fetchBysurname_First(
		...
		List<Loans> list = findBysurname(surname, 0, 1, orderByComparator);
	...
	public Loans findBysurname_Last(
		...
		Loans loans = fetchBysurname_Last(surname, orderByComparator);
	...
	public Loans[] findBysurname_PrevAndNext(
		...
		try {
			...
			array[0] = getBysurname_PrevAndNext(
				session, loans, surname, orderByComparator, true);

			array[1] = loans;

			array[2] = getBysurname_PrevAndNext(
				session, loans, surname, orderByComparator, false);
	...
	protected Loans getBysurname_PrevAndNext(
		Session session, Loans loans, String surname,
		OrderByComparator<Loans> orderByComparator, boolean previous) {
	...
	private static final String _FINDER_COLUMN_SURNAME_SURNAME_3 =
		"(loans.surname IS NULL OR loans.surname = '')";

	public LoansPersistenceImpl() {
		...
		setModelClass(Loans.class);

		setModelImplClass(LoansImpl.class);
		setModelPKClass(long.class);

		setTable(LoansTable.INSTANCE);
	}
	...
	public void cacheResult(Loans loans) {
		entityCache.putResult(LoansImpl.class, loans.getPrimaryKey(), loans);

		finderCache.putResult(
			_finderPathFetchByUUID_G,
			new Object[] {loans.getUuid(), loans.getGroupId()}, loans);
	}
	 ...
	 */
	@Override
	public void cacheResult(List<Loans> loanses) {
		if ((_valueObjectFinderCacheListThreshold == 0) ||
			((_valueObjectFinderCacheListThreshold > 0) &&
			 (loanses.size() > _valueObjectFinderCacheListThreshold))) {

			return;
		}

		for (Loans loans : loanses) {
			if (entityCache.getResult(LoansImpl.class, loans.getPrimaryKey()) ==
					null) {
	...
	/**
	 * Clears the cache for all loanses.
	 *
	 * <p>
	...
	public void clearCache() {
		entityCache.clearCache(LoansImpl.class);

		finderCache.clearCache(LoansImpl.class);
	}

	/**
	 * Clears the cache for the loans.
	 *
	 * <p>
	 * The <code>EntityCache</code> and <code>FinderCache</code> are both cleared by this method.
	 * </p>
	 */
	@Override
	public void clearCache(Loans loans) {
		entityCache.removeResult(LoansImpl.class, loans);
	}

	@Override
	public void clearCache(List<Loans> loanses) {
		for (Loans loans : loanses) {
			entityCache.removeResult(LoansImpl.class, loans);
		}
	}
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(LoansImpl.class, primaryKey);
		}
	}

	protected void cacheUniqueFindersCache(LoansModelImpl loansModelImpl) {
		Object[] args = new Object[] {
			loansModelImpl.getUuid(), loansModelImpl.getGroupId()
		};

		finderCache.putResult(_finderPathCountByUUID_G, args, Long.valueOf(1));
		finderCache.putResult(_finderPathFetchByUUID_G, args, loansModelImpl);
	}
	...
	public Loans create(long peopleId) {
		Loans loans = new LoansImpl();

		loans.setNew(true);
		loans.setPrimaryKey(peopleId);

		String uuid = PortalUUIDUtil.generate();

		loans.setUuid(uuid);

		loans.setCompanyId(CompanyThreadLocal.getCompanyId());
	 ...
	 * Removes the loans with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param primaryKey the primary key of the loans
	 * @return the loans that was removed
	 * @throws NoSuchLoansException if a loans with the primary key could not be found
	 */
	@Override
	public Loans remove(Serializable primaryKey) throws NoSuchLoansException {
		Session session = null;

		try {
			session = openSession();

			Loans loans = (Loans)session.get(LoansImpl.class, primaryKey);
			...
			if (loans == null) {
				...
				throw new NoSuchLoansException(
					_NO_SUCH_ENTITY_WITH_PRIMARY_KEY + primaryKey);
			}

			return remove(loans);
		}
		catch (NoSuchLoansException noSuchEntityException) {
	...
	@Override
	protected Loans removeImpl(Loans loans) {
		Session session = null;

		try {
			session = openSession();

			if (!session.contains(loans)) {
				loans = (Loans)session.get(
					LoansImpl.class, loans.getPrimaryKeyObj());
			}
	...
	public Loans updateImpl(Loans loans) {
		boolean isNew = loans.isNew();

		if (!(loans instanceof LoansModelImpl)) {
			InvocationHandler invocationHandler = null;

			if (ProxyUtil.isProxyClass(loans.getClass())) {
				invocationHandler = ProxyUtil.getInvocationHandler(loans);

				throw new IllegalArgumentException(
					"Implement ModelWrapper in loans proxy " +
						invocationHandler.getClass());
			}

			throw new IllegalArgumentException(
				"Implement ModelWrapper in custom Loans implementation " +
					loans.getClass());
		}

		LoansModelImpl loansModelImpl = (LoansModelImpl)loans;

		if (Validator.isNull(loans.getUuid())) {
			String uuid = PortalUUIDUtil.generate();
		...
		if (isNew && (loans.getCreateDate() == null)) {
			if (serviceContext == null) {
				loans.setCreateDate(date);
			}
			else {
				loans.setCreateDate(serviceContext.getCreateDate(date));
			}
		}

		if (!loansModelImpl.hasSetModifiedDate()) {
			if (serviceContext == null) {
				loans.setModifiedDate(date);
			}
			else {
				loans.setModifiedDate(serviceContext.getModifiedDate(date));
			}
		}
		...
		try {
			...
			if (isNew) {
				...
				loans = (Loans)session.merge(loans);
			}
		}
		catch (Exception exception) {
			throw processException(exception);
		...
		entityCache.putResult(LoansImpl.class, loansModelImpl, false, true);

		cacheUniqueFindersCache(loansModelImpl);

		if (isNew) {
			loans.setNew(false);
		}

		loans.resetOriginalValues();

		return loans;
	}

	/**
	 * Returns the loans with the primary key or throws a <code>com.liferay.portal.kernel.exception.NoSuchModelException</code> if it could not be found.
	 *
	 * @param primaryKey the primary key of the loans
	 * @return the loans
	 * @throws NoSuchLoansException if a loans with the primary key could not be found
	 */
	@Override
	public Loans findByPrimaryKey(Serializable primaryKey)
		throws NoSuchLoansException {

		Loans loans = fetchByPrimaryKey(primaryKey);
	 ...
	 */
	@Override
	public List<Loans> findAll(int start, int end) {
	...
	public List<Loans> findAll(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sql = _SQL_SELECT_LOANS;

				sql = sql.concat(LoansModelImpl.ORDER_BY_JPQL);
			}
	...
	public int countAll() {
		...
		if (count == null) {
			...
			try {
				...
				Query query = session.createQuery(_SQL_COUNT_LOANS);
	...
	protected String getSelectSQL() {
		return _SQL_SELECT_LOANS;
	}

	@Override
	protected Map<String, Integer> getTableColumnsMap() {
		return LoansModelImpl.TABLE_COLUMNS_MAP;
	}

	/**
	 * Initializes the loans persistence.
	 */
	@Activate
	public void activate() {
		...
		_setLoansUtilPersistence(this);
	}

	@Deactivate
	public void deactivate() {
		_setLoansUtilPersistence(null);

		entityCache.removeCache(LoansImpl.class.getName());
	}

	private void _setLoansUtilPersistence(LoansPersistence loansPersistence) {
		try {
			Field field = LoansUtil.class.getDeclaredField("_persistence");

			field.setAccessible(true);

			field.set(null, loansPersistence);
		}
	...
	@Override
	@Reference(
		target = PeoplePersistenceConstants.SERVICE_CONFIGURATION_FILTER,
		unbind = "-"
	)
	...
	@Override
	@Reference(
		target = PeoplePersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
	...
	private static final String _SQL_SELECT_LOANS =
		"SELECT loans FROM Loans loans";

	private static final String _SQL_SELECT_LOANS_WHERE =
		"SELECT loans FROM Loans loans WHERE ";

	private static final String _SQL_COUNT_LOANS =
		"SELECT COUNT(loans) FROM Loans loans";

	private static final String _SQL_COUNT_LOANS_WHERE =
		"SELECT COUNT(loans) FROM Loans loans WHERE ";

	private static final String _ORDER_BY_ENTITY_ALIAS = "loans.";

	private static final String _NO_SUCH_ENTITY_WITH_PRIMARY_KEY =
		"No Loans exists with the primary key ";

	private static final String _NO_SUCH_ENTITY_WITH_KEY =
		"No Loans exists with the key {";

	private static final Log _log = LogFactoryUtil.getLog(
		LoansPersistenceImpl.class);
	...
	@Reference
	private LoansModelArgumentsResolver _loansModelArgumentsResolver;
